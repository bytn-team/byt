...
from fake_stake.base_test import BYTN_FakeStakeTest

class zBYTValidCoinSpendTest(BYTN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zBYTs..." % DENOM_TO_USE)
