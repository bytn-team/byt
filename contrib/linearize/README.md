# Linearize
Construct a linear, no-fork, best version of the BYTN blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install bytn_hash

https://github.com/bytnpay/bytn_hash
...
JSON-RPC server. Running `bytnd` or `bytn-qt -server` will be sufficient.
...
* `input`: bytnd blocks/ directory containing blkNNNNN.dat
