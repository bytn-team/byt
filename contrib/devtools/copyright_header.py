...
Arguments:
    <base_directory> - The base directory of a BYTN Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BYTN Core developers'
...
Arguments:
    <base_directory> - The base directory of BYTN Core source code repository.
"""
...
Arguments:
    <file> - A source file in the BYTN Core repository.
"""
