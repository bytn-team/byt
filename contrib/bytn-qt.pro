...
RESOURCES += src/qt/bytn.qrc src/qt/bytn_locale.qrc

TRANSLATIONS += src/qt/locale/bytn_bg.ts \
                src/qt/locale/bytn_de.ts \
                src/qt/locale/bytn_en.ts \
                src/qt/locale/bytn_es.ts \
                src/qt/locale/bytn_fi.ts \
                src/qt/locale/bytn_fr.ts \
                src/qt/locale/bytn_it.ts \
                src/qt/locale/bytn_ja.ts \
                src/qt/locale/bytn_pl.ts \
                src/qt/locale/bytn_pt.ts \
                src/qt/locale/bytn_ru.ts \
                src/qt/locale/bytn_sk.ts \
                src/qt/locale/bytn_sv.ts \
                src/qt/locale/bytn_vi.ts \
                src/qt/locale/bytn_zh_CN.ts \
                src/qt/locale/bytn_zh_TW.ts
