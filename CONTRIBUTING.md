Contributing to BYTN Core
============================

The BYTN Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bytn-project/bytn/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BYTN Core project, and is not to be
confused with overall BYTN Network Protocol consensus changes.

Whether a pull request is merged into BYTN Core rests with the project merge
...
Patches that change BYTN consensus rules are considerably more involved than
...
Where a patchset proposes to change the BYTN consensus, it must have been
...
The project leader is the release manager for each BYTN Core release.
