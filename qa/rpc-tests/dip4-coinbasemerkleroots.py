...
from test_framework.test_framework import BYTNTestFramework
...
class LLMQCoinbaseCommitmentsTest(BYTNTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as BYTNTestFramework doesn't support this atm)
