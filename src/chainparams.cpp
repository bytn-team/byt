...
// Copyright (c) 2020 The BYTN Core developers
 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1594451711, nBits=1e0ffff0, nNonce=351241, vtx=1)
...
{
    const char* pszTimestamp = "Ihre Killer banden ihr eine Betonplatte an den fuss 10.07.2020";
    const CScript genesisOutputScript = CScript() << ParseHex("042f90314b275034f4ddef3f4bc81a0a52043cfb093bd158713cd315d67985d089c08178c9326c657b55f64ca29ceb36e8d06c1a24861e6fca033b49929eb754bb") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x00000b8640a567116559712b97a3b6d3496cf4525d749dd90e2b106aac78021e"); 
        ...
        vAlertPubKey = ParseHex("044bfced85e5043c73f699d84c59296c6aa90a06a672cdf27ea909f1fab25a80088195845366efd4d159cedbf355505f55179f66acede87626afc1559b7adbbb42");
        nDefaultPort = 21170;
        nPruneAfterHeight = 100000;

        genesis = CreateGenesisBlock(1594451711, 351241, 0x1e0ffff0, 1, 25 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000b8640a567116559712b97a3b6d3496cf4525d749dd90e2b106aac78021e"));
        assert(genesis.hashMerkleRoot == uint256S("0xf5ff713d839d62d55e508246e6d3caef07931501eb37a809fbdcf038adca6a2a"));


        vSeeds.push_back(CDNSSeedData("172.67.211.168", "136.144.171.201"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,25);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,26);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,153);
        // BYTN BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // BYTN BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // BYTN BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"BQaiDmh2naPbEgje7KZmmw2VvChxrWdkAp"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (  0, uint256S("0x00000b8640a567116559712b97a3b6d3496cf4525d749dd90e2b106aac78021e"))
        };

        chainTxData = ChainTxData{
            1594451711, // * UNIX timestamp of last known number of transactions (Block 1068571)
...
public:
    CTestNetParams() {
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x000000ae5449ac90213958b25037dd46fd5b535b89364c2bcf3c678278a6780e"); 

        pchMessageStart[0] = 0x88;
        pchMessageStart[1] = 0x50;
        pchMessageStart[2] = 0x0b;
        pchMessageStart[3] = 0xec;
        vAlertPubKey = ParseHex("04420687be7d539d8ca132ee495fb7a4dda301dfd62a9c4b535366fdbbad3174c4a0f3205ba284c77422ee707967f3a33de80b678188e81457de55755f46344c11");
        nDefaultPort = 31170;
        nPruneAfterHeight = 1000;

        genesis = CreateGenesisBlock(1594451716UL, 1267578UL, 0x1e0ffff0, 1, 25 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x000000ae5449ac90213958b25037dd46fd5b535b89364c2bcf3c678278a6780e"));
        assert(genesis.hashMerkleRoot == uint256S("0xf5ff713d839d62d55e508246e6d3caef07931501eb37a809fbdcf038adca6a2a"));
        ...
        // Testnet BYTN BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet BYTN BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet BYTN BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"2baT8RESXEJfzRG4dBdjL6646WKb7agKBE"};
        nMinSporkKeys = 1;
        fBIP9CheckMasternodesUpgraded = true;

        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (    0, uint256S("0x000000ae5449ac90213958b25037dd46fd5b535b89364c2bcf3c678278a6780e"))
        };

        chainTxData = ChainTxData{
            1594451716, // * UNIX timestamp of last known number of transactions (Block 96717)
            0,     // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams() {
        ...
        genesis = CreateGenesisBlock(1594451721, 1, 0x207fffff, 1, 25 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x1a7535432d803d1d3cbe43a71c2109220e285ba81b8192b7c18dab0e88b79973"));
        assert(genesis.hashMerkleRoot == uint256S("0xf5ff713d839d62d55e508246e6d3caef07931501eb37a809fbdcf038adca6a2a"));

        devnetGenesis = FindDevNetGenesisBlock(consensus, genesis, 25 * COIN);
        consensus.hashDevnetGenesisBlock = devnetGenesis.GetHash();

        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("bytnevo.org",  "devnet-seed.bytnevo.org"));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            (      0, uint256S("0x1a7535432d803d1d3cbe43a71c2109220e285ba81b8192b7c18dab0e88b79973"))
...
public:
    CRegTestParams() {
        ...
        // privKey: 5QshghT5ADnUw4baQAJz6SdQyhboFvMZfEnuBRMct4gfexFE6KW
        vSporkAddresses = {"2cKdFruMjCbCw3TBBaWw3vbvRpSNtSdLQh"};
        nMinSporkKeys = 1;
        ...
        // Regtest BYTN addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,3);
        // Regtest BYTN script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,4);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,131);
        // Regtest BYTN BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest BYTN BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest BYTN BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
