                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzBYTPathCustom = GetArg("-zbytbackuppath", "");
    ...
    if(!strzBYTPathCustom.empty()) {
        ui->wallet_customzbytbackuppath->setText(QString::fromStdString(strzBYTPathCustom));
        ui->wallet_customzbytbackuppath_label->setVisible(true);
        ui->wallet_customzbytbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzBYTPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BYTN RPC console.") + "<br>" +
