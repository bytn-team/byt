...
#ifndef BYTN_ZBYTTRACKER_H
#define BYTN_ZBYTTRACKER_H
...
public:
    CzBYTTracker(std::string strWalletFile);
    ~CzBYTTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzBYTWallet* zBYTWallet = NULL);
