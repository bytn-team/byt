...
#ifndef BYTN_ZBYTWALLET_H
#define BYTN_ZBYTWALLET_H
...
public:
    CzBYTWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZBYT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZBYT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
