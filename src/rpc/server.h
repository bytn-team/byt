...
extern UniValue DoZbytSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzbytseed(const UniValue& params, bool fHelp);
extern UniValue getzbytseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzbyt(const UniValue& params, bool fHelp);
extern UniValue dzbytstate(const UniValue& params, bool fHelp);
