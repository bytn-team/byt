...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner BYTN address\n"
            "  payee          - Print the masternode payout BYTN address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting BYTN address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "bytn",               "masternode",             &masternode,             true,  {} },
    { "bytn",               "masternodelist",         &masternodelist,         true,  {} },
    { "bytn",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "bytn",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
