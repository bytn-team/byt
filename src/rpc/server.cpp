...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BYTN features */
        {"bytn", "listmasternodes", &listmasternodes, true, true, false},
        {"bytn", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bytn", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bytn", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bytn", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bytn", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bytn", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bytn", "masternodedebug", &masternodedebug, true, true, false},
        {"bytn", "startmasternode", &startmasternode, true, true, false},
        {"bytn", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bytn", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bytn", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bytn", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bytn", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bytn", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bytn", "preparebudget", &preparebudget, true, true, false},
        {"bytn", "submitbudget", &submitbudget, true, true, false},
        {"bytn", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bytn", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bytn", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bytn", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bytn", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bytn", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bytn", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bytn", "checkbudgets", &checkbudgets, true, true, false},
        {"bytn", "mnsync", &mnsync, true, true, false},
        {"bytn", "spork", &spork, true, true, false},
        {"bytn", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzbytseed", &getzbytseed, false, false, true},
        {"zerocoin", "setzbytseed", &setzbytseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzbyt", &searchdzbyt, false, false, true},
        {"zerocoin", "dzbytstate", &dzbytstate, false, false, true},
...
{
    return "> bytn-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21647/\n";
}
