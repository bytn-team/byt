...
* bytn.conf: contains configuration settings for bytnd or bytn-qt
* bytnd.pid: stores the process id of bytnd while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by bytnd or bytn-qt
