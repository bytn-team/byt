...
This mechanism has been integrated into Bitcore-Node-BYTN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bytnpay/insight-api-bytn#web-socket-api](https://github.com/bytnpay/insight-api-bytn#web-socket-api)
* API: [https://github.com/bytnpay/insight-api-bytn#instantsend-transactions](https://github.com/bytnpay/insight-api-bytn#instantsend-transactions)
